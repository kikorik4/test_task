...
Приложение предоставляет API для создания, чтения и удаления товаров и категорий. Оно использует Flask-SQLAlchemy для взаимодействия с базой данных и Docker для упрощения развертывания.
